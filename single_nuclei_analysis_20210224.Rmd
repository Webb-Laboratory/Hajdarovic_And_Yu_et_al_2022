...
write.csv(bulk_MAST, "Supplementary_Table_2_DE_Bulk.csv")
...
write.csv(cell_DE_res_merge, "Supplementary_Table_3.csv")
...
#gsea_res_hallmark_merge<-dplyr::filter(gsea_res_hallmark_merge, pathway != NA)
...
p1<-ggplot(data=count_dat_auto, aes(x=chrom, y=n, fill=updown)) + 
  geom_bar(position="dodge", stat="identity") +
...
write.csv(neuro.res.merge, "Supplementary_Table_7.csv")
...
neuro.res.plot<-dplyr::filter(neuro.res.merge, cell_type != "3. Tac2/Tcf4"& cell_type != "5. Galntl6/Il1rapl2"& cell_type != "7. 1700042O10Rik/Ddc" & cell_type != "9. Hdc/Slc16a10" & cell_type != "31. Tac1/Sgcd")
